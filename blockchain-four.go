...
func RunBlockchainFour() {
	fmt.Println("=== Blockchain with CLI Interface (Pattern 4) ===")
	fmt.Println("This pattern provides a CLI interface using Cobra.")
	fmt.Println("To use CLI commands, build the application first:")
	fmt.Println("  go build -o blockchain .")
	fmt.Println("  ./blockchain printchain")
	fmt.Println("  ./blockchain addblock --data \"Your data here\"")
}
